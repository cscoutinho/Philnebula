...
const SUPABASE_URL = process.env.SUPABASE_URL || 'https://kowbxomppzqgmfagzirc.supabase.co';
const SUPABASE_ANON_KEY = process.env.SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imtvd2J4b21wcHpxZ21mYWd6aXJjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTMyOTI1MTMsImV4cCI6MjA2ODg2ODUxM30.3R92DVk_HPQBtGc4V3stf7UWQxMeNeazXdZEj_BZdk0';
...
const App: React.FC = () => {
    ...
    // View Management
    const [currentView, setCurrentView] = useState<'nebula' | 'map' | 'feed' | 'nexus' | 'wiki'>('nebula');
    ...
    return (
        <div className="relative w-screen h-screen overflow-hidden bg-black text-white">
            ...
            {(currentView === 'nebula' || currentView === 'map') && (
                 <MapTray 
