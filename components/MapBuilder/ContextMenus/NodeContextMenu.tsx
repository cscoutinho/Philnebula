    ...
    return (
        <div className="fixed bg-gray-800 border border-gray-600 rounded-md shadow-lg p-1 z-50 text-white text-sm animate-fade-in" onClick={e => e.stopPropagation()}>
            ...
            <div className="my-1 border-t border-gray-700"></div>
             <button onClick={() => onEditNote(nodeContextMenu.nodeId)} className="block w-full text-left px-3 py-1.5 hover:bg-gray-700 rounded flex items-center gap-2"><NoteIcon className="w-4 h-4"/>Open Notes Studio</button>
