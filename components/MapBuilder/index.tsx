...
const MapBuilder: React.FC<MapBuilderProps> = ({ 
    ...
    const aiHooks = useMapAI({
        ...
        aiAssistanceLevel,
        setEditLinkTypesMenu: ui.setEditLinkTypesMenu,
        allNodes,
    });
    ...
    return (
        <div className="w-full h-full relative">
            ...
            {ui.linkContextMenu && <div ref={linkContextMenuRef} style={linkContextMenuStyle}><LinkContextMenu linkContextMenu={ui.linkContextMenu} setLogicalWorkbench={ui.setLogicalWorkbench} handleFormalizeArgument={(state) => aiHooks.handleFormalizeArgument(state)} setLinkContextMenu={ui.setLinkContextMenu} handleExploreImplications={aiHooks.handleExploreImplications} generateJustification={aiHooks.generateJustification} setEditLinkTypesMenu={ui.setEditLinkTypesMenu} updateLinkPathStyle={ui.updateLinkPathStyle} flipLinkCurve={ui.flipLinkCurve} deleteLink={ui.deleteLink} handleAnalyzeDefinition={aiHooks.handleAnalyzeDefinition} handleGenerateCounterExample={aiHooks.handleGenerateCounterExample} handleGenerateAlternativeHypothesis={aiHooks.handleGenerateAlternativeHypothesis} /></div>}
