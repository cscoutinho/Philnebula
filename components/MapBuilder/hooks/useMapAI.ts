...
import type { MapNode, MapLink, Citation, FormalizationResult, LogicalConstruct, DefinitionAnalysisState, DefinitionResult, CounterExampleResult, MapBuilderProps, LogicalWorkbenchState, AnalysisResult } from '../../../types';
